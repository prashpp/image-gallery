					...
					<div class="col">
						<div class="row justify-content-center">
							<div class="col-12 col-md-5 text-center">
								<form method="post" action="getimg.php" enctype="multipart/form-data">
									<div class="form-row">
										<div class="col">
											<div class="options">
									...
									<div class="form-row justify-content-center">
										<div class="col">
											<div class="input-file-container">
												...
												<label tabindex="0" for="my-file" class="input-file-trigger">Choose Images</label>
											</div>
											<p class="file-return"></p>
										</div>
									</div>
									<input class="btn btn-dark text-light" type="Submit" name="imageSubmit">
